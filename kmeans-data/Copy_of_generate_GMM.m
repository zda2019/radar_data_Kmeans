function [data,cluster] = Copy_of_generate_GMM(N)
%数据规模
% N = N;
%数据维度
% dim=2;
...
cluster = [ones(length(data1),1)*1;ones(length(data2),1)*2;ones(length(data3),1)*3;ones(length(data4),1)*4];
