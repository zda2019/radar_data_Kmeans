-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\newsimul\Subsystem_ip_src_RADIX22FFT_SDNF1_5_block11.vhd
...
ENTITY Subsystem_ip_src_RADIX22FFT_SDNF1_5_block11 IS
...
END Subsystem_ip_src_RADIX22FFT_SDNF1_5_block11;


ARCHITECTURE rtl OF Subsystem_ip_src_RADIX22FFT_SDNF1_5_block11 IS

  -- Component Declarations
  COMPONENT Subsystem_ip_src_Complex4Multiply_block39
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
  ...
  FOR ALL : Subsystem_ip_src_Complex4Multiply_block39
    USE ENTITY work.Subsystem_ip_src_Complex4Multiply_block39(rtl);
...
BEGIN
  u_MUL4_2 : Subsystem_ip_src_Complex4Multiply_block39
    PORT MAP( clk => clk,
              reset => reset,
