-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\newsimul\Subsystem_ip_src_TWDLROM_5_10.vhd
...
-- Source Path: newsimul/Subsystem/Subsystem/Channelizer/FFT/TWDLROM_5_10
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Subsystem_ip_src_TWDLROM_5_10 IS
...
END Subsystem_ip_src_TWDLROM_5_10;


ARCHITECTURE rtl OF Subsystem_ip_src_TWDLROM_5_10 IS
  ...
  SIGNAL twdl_5_10_re_tmp                 : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdl_5_10_im_tmp                 : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  ...
  BEGIN
    ...
    ELSE 
      ...
      END CASE;
    END IF;
    twdl_5_10_re_tmp <= twdlIn_re;
    twdl_5_10_im_tmp <= twdlIn_im;
  END PROCESS Radix22TwdlOctCorr_output;


  twdl_5_10_re <= std_logic_vector(twdl_5_10_re_tmp);

  twdl_5_10_im <= std_logic_vector(twdl_5_10_im_tmp);
