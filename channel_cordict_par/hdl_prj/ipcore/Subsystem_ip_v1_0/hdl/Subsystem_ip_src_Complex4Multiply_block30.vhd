-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\newsimul\Subsystem_ip_src_Complex4Multiply_block30.vhd
...
ENTITY Subsystem_ip_src_Complex4Multiply_block30 IS
...
END Subsystem_ip_src_Complex4Multiply_block30;


ARCHITECTURE rtl OF Subsystem_ip_src_Complex4Multiply_block30 IS
  ...
  SIGNAL twdl_5_8_re_signed               : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdl_re_reg                      : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdl_5_8_im_signed               : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  ...
  twdl_5_8_re_signed <= signed(twdl_5_8_re);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_32_0 = '1' THEN
        twdl_re_reg <= twdl_5_8_re_signed;
      END IF;
    END IF;
  END PROCESS intdelay_2_process;


  twdl_5_8_im_signed <= signed(twdl_5_8_im);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_32_0 = '1' THEN
        twdl_im_reg <= twdl_5_8_im_signed;
      END IF;
    END IF;
