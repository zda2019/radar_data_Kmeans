-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\newsimul\Subsystem_ip_axi_lite_module.vhd
...
-- Source Path: Subsystem_ip/Subsystem_ip_axi_lite/Subsystem_ip_axi_lite_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Subsystem_ip_axi_lite_module IS
...
END Subsystem_ip_axi_lite_module;


ARCHITECTURE rtl OF Subsystem_ip_axi_lite_module IS
...
BEGIN
  ...
  BEGIN
    ...
    CASE axi_lite_rstate IS
      WHEN "00000000" =>
        ...
        rvalid_int <= '0';
        IF (arvalid = '1' AND (axi_lite_wstate = to_unsigned(16#00000000#, 8))) AND ( NOT awvalid) = '1' THEN 
  ...
  addr_sel_tmp <= waddr_sel WHEN ar_transfer = '0' ELSE
      raddr_sel;
