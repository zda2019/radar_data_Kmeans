-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\newsimul\Subsystem_ip_src_Complex4Multiply_block1.vhd
...
ENTITY Subsystem_ip_src_Complex4Multiply_block1 IS
...
END Subsystem_ip_src_Complex4Multiply_block1;


ARCHITECTURE rtl OF Subsystem_ip_src_Complex4Multiply_block1 IS
  ...
  SIGNAL twdlXdin_4_re_tmp                : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL twdlXdin_4_im_tmp                : signed(15 DOWNTO 0);  -- sfix16_En15
...
BEGIN
  ...
  twdlXdin_4_re_tmp <= mulResFP_re(29 DOWNTO 14);

  twdlXdin_4_re <= std_logic_vector(twdlXdin_4_re_tmp);

  twdlXdin_4_im_tmp <= mulResFP_im(29 DOWNTO 14);
