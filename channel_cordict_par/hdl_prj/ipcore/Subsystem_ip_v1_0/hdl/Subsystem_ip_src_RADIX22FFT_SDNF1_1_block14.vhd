-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\newsimul\Subsystem_ip_src_RADIX22FFT_SDNF1_1_block14.vhd
...
ENTITY Subsystem_ip_src_RADIX22FFT_SDNF1_1_block14 IS
...
END Subsystem_ip_src_RADIX22FFT_SDNF1_1_block14;


ARCHITECTURE rtl OF Subsystem_ip_src_RADIX22FFT_SDNF1_1_block14 IS

  -- Signals
  SIGNAL twdlXdin_16_re_signed            : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL twdlXdin_16_im_signed            : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL twdlXdin_32_re_signed            : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL twdlXdin_32_im_signed            : signed(15 DOWNTO 0);  -- sfix16_En15
...
BEGIN
  ...
  Radix22ButterflyG1_NF_output : PROCESS (Radix22ButterflyG1_NF_btf1_im_reg, Radix22ButterflyG1_NF_btf1_re_reg,
       ...
       Radix22ButterflyG1_NF_dinXtwdl_vld_dly1, twdlXdin_16_im_signed,
       twdlXdin_16_re_signed, twdlXdin_1_vld, twdlXdin_32_im_signed,
  ...
  BEGIN
    ...
    IF twdlXdin_1_vld = '1' THEN 
      add_cast := resize(twdlXdin_16_re_signed, 17);
      add_cast_0 := resize(twdlXdin_32_re_signed, 17);
      Radix22ButterflyG1_NF_btf1_re_reg_next <= add_cast + add_cast_0;
      sub_cast := resize(twdlXdin_16_re_signed, 17);
      sub_cast_0 := resize(twdlXdin_32_re_signed, 17);
      Radix22ButterflyG1_NF_btf2_re_reg_next <= sub_cast - sub_cast_0;
      add_cast_1 := resize(twdlXdin_16_im_signed, 17);
      add_cast_2 := resize(twdlXdin_32_im_signed, 17);
      Radix22ButterflyG1_NF_btf1_im_reg_next <= add_cast_1 + add_cast_2;
      sub_cast_1 := resize(twdlXdin_16_im_signed, 17);
      sub_cast_2 := resize(twdlXdin_32_im_signed, 17);
