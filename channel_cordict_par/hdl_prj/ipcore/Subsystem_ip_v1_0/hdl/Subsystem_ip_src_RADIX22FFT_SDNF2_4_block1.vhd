-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\newsimul\Subsystem_ip_src_RADIX22FFT_SDNF2_4_block1.vhd
...
ENTITY Subsystem_ip_src_RADIX22FFT_SDNF2_4_block1 IS
...
END Subsystem_ip_src_RADIX22FFT_SDNF2_4_block1;


ARCHITECTURE rtl OF Subsystem_ip_src_RADIX22FFT_SDNF2_4_block1 IS
  ...
  SIGNAL dout_5_re_tmp                    : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dout_5_im_tmp                    : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dout_6_re_tmp                    : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dout_6_im_tmp                    : signed(15 DOWNTO 0);  -- sfix16_En15
...
BEGIN
  ...
  Radix22ButterflyG2_NF_output : PROCESS (Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
       ...
       Radix22ButterflyG2_NF_din_vld_dly, dout_1_vld, dout_2_im_signed,
       dout_2_re_signed, dout_6_im_signed, dout_6_re_signed, rotate_5)
  ...
  dout_6_re_1 <= std_logic_vector(dout_6_re_tmp);

  dout_6_im_1 <= std_logic_vector(dout_6_im_tmp);
