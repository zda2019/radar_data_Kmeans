-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\newsimul\Subsystem_ip_src_RADIX22FFT_SDNF1_3_block4.vhd
...
ENTITY Subsystem_ip_src_RADIX22FFT_SDNF1_3_block4 IS
...
END Subsystem_ip_src_RADIX22FFT_SDNF1_3_block4;


ARCHITECTURE rtl OF Subsystem_ip_src_RADIX22FFT_SDNF1_3_block4 IS

  -- Signals
  SIGNAL twdlXdin_10_re_signed            : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL twdlXdin_10_im_signed            : signed(15 DOWNTO 0);  -- sfix16_En15
...
BEGIN
  ...
  Radix22ButterflyG1_NF_output : PROCESS (Radix22ButterflyG1_NF_btf1_im_reg, Radix22ButterflyG1_NF_btf1_re_reg,
       ...
       Radix22ButterflyG1_NF_dinXtwdl_vld_dly1, twdlXdin_10_im_signed,
       twdlXdin_10_re_signed, twdlXdin_14_im_signed, twdlXdin_14_re_signed,
       twdlXdin_1_vld)
