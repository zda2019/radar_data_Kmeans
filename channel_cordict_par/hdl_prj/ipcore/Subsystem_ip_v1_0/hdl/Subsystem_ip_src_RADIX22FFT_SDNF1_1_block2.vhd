-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\newsimul\Subsystem_ip_src_RADIX22FFT_SDNF1_1_block2.vhd
...
ENTITY Subsystem_ip_src_RADIX22FFT_SDNF1_1_block2 IS
...
END Subsystem_ip_src_RADIX22FFT_SDNF1_1_block2;


ARCHITECTURE rtl OF Subsystem_ip_src_RADIX22FFT_SDNF1_1_block2 IS

  -- Signals
  SIGNAL twdlXdin_4_re_signed             : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL twdlXdin_4_im_signed             : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL twdlXdin_20_re_signed            : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL twdlXdin_20_im_signed            : signed(15 DOWNTO 0);  -- sfix16_En15
...
BEGIN
  ...
  Radix22ButterflyG1_NF_output : PROCESS (Radix22ButterflyG1_NF_btf1_im_reg, Radix22ButterflyG1_NF_btf1_re_reg,
       ...
       twdlXdin_20_im_signed, twdlXdin_20_re_signed, twdlXdin_4_im_signed,
       twdlXdin_4_re_signed)
