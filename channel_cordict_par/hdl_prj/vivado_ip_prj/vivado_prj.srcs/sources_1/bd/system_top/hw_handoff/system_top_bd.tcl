...
proc create_root_design { parentCell } {
  ...
  # Create instance: Subsystem_ip_0, and set properties
  set Subsystem_ip_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:Subsystem_ip:1.0 Subsystem_ip_0 ]
  ...
  # Create instance: sys_100m_rstgen, and set properties
  set sys_100m_rstgen [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 sys_100m_rstgen ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net axi_cpu_interconnect_M00_AXI [get_bd_intf_pins Subsystem_ip_0/AXI4_Lite] [get_bd_intf_pins axi_cpu_interconnect/M00_AXI]
  ...
  connect_bd_net -net const_intr_concat_gnd [get_bd_pins const_intr_concat_gnd/dout] [get_bd_pins intr_concat/In0] [get_bd_pins intr_concat/In1] [get_bd_pins intr_concat/In2] [get_bd_pins intr_concat/In3] [get_bd_pins intr_concat/In4] [get_bd_pins intr_concat/In5] [get_bd_pins intr_concat/In6] [get_bd_pins intr_concat/In7] [get_bd_pins intr_concat/In8] [get_bd_pins intr_concat/In9] [get_bd_pins intr_concat/In10] [get_bd_pins intr_concat/In11] [get_bd_pins intr_concat/In12] [get_bd_pins intr_concat/In13] [get_bd_pins intr_concat/In14] [get_bd_pins intr_concat/In15]
  ...
  connect_bd_net -net proc_100m_resetn [get_bd_pins core_clkwiz/resetn] [get_bd_pins sys_100m_rstgen/ext_reset_in] [get_bd_pins sys_core_rstgen/ext_reset_in] [get_bd_pins sys_cpu/FCLK_RESET0_N]
  connect_bd_net -net sys_100m_clk [get_bd_pins axi_cpu_interconnect/ACLK] [get_bd_pins axi_cpu_interconnect/S00_ACLK] [get_bd_pins core_clkwiz/clk_in1] [get_bd_pins sys_100m_rstgen/slowest_sync_clk] [get_bd_pins sys_cpu/FCLK_CLK0] [get_bd_pins sys_cpu/M_AXI_GP0_ACLK]
  connect_bd_net -net sys_100m_resetn [get_bd_pins axi_cpu_interconnect/ARESETN] [get_bd_pins axi_cpu_interconnect/S00_ARESETN] [get_bd_pins sys_100m_rstgen/peripheral_aresetn]
  connect_bd_net -net sys_core_clk [get_bd_pins Subsystem_ip_0/AXI4_Lite_ACLK] [get_bd_pins Subsystem_ip_0/IPCORE_CLK] [get_bd_pins axi_cpu_interconnect/M00_ACLK] [get_bd_pins core_clkwiz/clk_out1] [get_bd_pins sys_core_rstgen/slowest_sync_clk]
  connect_bd_net -net sys_core_resetn [get_bd_pins Subsystem_ip_0/AXI4_Lite_ARESETN] [get_bd_pins Subsystem_ip_0/IPCORE_RESETN] [get_bd_pins axi_cpu_interconnect/M00_ARESETN] [get_bd_pins sys_core_rstgen/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x40010000 [get_bd_addr_spaces sys_cpu/Data] [get_bd_addr_segs Subsystem_ip_0/AXI4_Lite/reg0] SEG_Subsystem_ip_0_reg0
