-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\newsimul\Subsystem_ip_src_TWDLMULT_SDNF1_3.vhd
...
ENTITY Subsystem_ip_src_TWDLMULT_SDNF1_3 IS
...
END Subsystem_ip_src_TWDLMULT_SDNF1_3;


ARCHITECTURE rtl OF Subsystem_ip_src_TWDLMULT_SDNF1_3 IS

  -- Component Declarations
  COMPONENT Subsystem_ip_src_Complex4Multiply
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
  ...
  FOR ALL : Subsystem_ip_src_Complex4Multiply
    USE ENTITY work.Subsystem_ip_src_Complex4Multiply(rtl);
...
BEGIN
  u_MUL4_2 : Subsystem_ip_src_Complex4Multiply
    PORT MAP( clk => clk,
              reset => reset,
              ...
              twdlXdin_2_re => twdlXdin_2_re_tmp,  -- sfix16_En15
              twdlXdin_2_im => twdlXdin_2_im_tmp,  -- sfix16_En15
