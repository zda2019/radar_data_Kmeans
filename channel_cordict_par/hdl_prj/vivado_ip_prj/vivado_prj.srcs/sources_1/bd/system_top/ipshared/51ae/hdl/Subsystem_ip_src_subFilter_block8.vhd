-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\newsimul\Subsystem_ip_src_subFilter_block8.vhd
...
ENTITY Subsystem_ip_src_subFilter_block8 IS
...
END Subsystem_ip_src_subFilter_block8;


ARCHITECTURE rtl OF Subsystem_ip_src_subFilter_block8 IS

  -- Component Declarations
  COMPONENT Subsystem_ip_src_FilterTapWvldIn_block8
    PORT( clk                             :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
          dinReg2_9_re                    :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En15
  ...
  FOR ALL : Subsystem_ip_src_FilterTapWvldIn_block8
    USE ENTITY work.Subsystem_ip_src_FilterTapWvldIn_block8(rtl);
...
BEGIN
  u_FilterTap_1 : Subsystem_ip_src_FilterTapWvldIn_block8
    PORT MAP( clk => clk,
              enb_1_32_0 => enb_1_32_0,
              dinReg2_9_re => dinReg2_9_re,  -- sfix16_En15
  ...
  u_FilterTap_2 : Subsystem_ip_src_FilterTapWvldIn_block8
    PORT MAP( clk => clk,
              enb_1_32_0 => enb_1_32_0,
              dinReg2_9_re => dinReg2_9_re,  -- sfix16_En15
  ...
  BEGIN
    IF reset = '1' THEN
      dout_10_re_tmp <= to_signed(16#0000#, 16);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_32_0 = '1' THEN
        IF syncReset = '1' THEN
          dout_10_re_tmp <= to_signed(16#0000#, 16);
        ELSE 
          dout_10_re_tmp <= muxOut;
        END IF;
      END IF;
    END IF;
