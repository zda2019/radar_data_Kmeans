-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\newsimul\Subsystem_ip_src_TWDLMULT_SDNF1_3_block8.vhd
...
ENTITY Subsystem_ip_src_TWDLMULT_SDNF1_3_block8 IS
...
END Subsystem_ip_src_TWDLMULT_SDNF1_3_block8;


ARCHITECTURE rtl OF Subsystem_ip_src_TWDLMULT_SDNF1_3_block8 IS

  -- Component Declarations
  COMPONENT Subsystem_ip_src_Complex4Multiply_block14
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
  ...
  COMPONENT Subsystem_ip_src_Complex4Multiply_block15
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
  ...
  FOR ALL : Subsystem_ip_src_Complex4Multiply_block14
    USE ENTITY work.Subsystem_ip_src_Complex4Multiply_block14(rtl);

  FOR ALL : Subsystem_ip_src_Complex4Multiply_block15
    USE ENTITY work.Subsystem_ip_src_Complex4Multiply_block15(rtl);

  -- Signals
  SIGNAL dout_21_re_signed                : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL din1_re_dly1                     : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL din1_re_dly2                     : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dout_21_im_signed                : signed(15 DOWNTO 0);  -- sfix16_En15
  ...
  SIGNAL twdlXdin_19_re_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL twdlXdin_19_im_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL dout_23_re_signed                : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL din2_re_dly1                     : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL din2_re_dly2                     : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dout_23_im_signed                : signed(15 DOWNTO 0);  -- sfix16_En15
  ...
  SIGNAL twdlXdin_20_re_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL twdlXdin_20_im_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16

BEGIN
  u_MUL4_1 : Subsystem_ip_src_Complex4Multiply_block14
    PORT MAP( clk => clk,
              reset => reset,
              ...
              twdlXdin_19_re => twdlXdin_19_re_tmp,  -- sfix16_En15
              twdlXdin_19_im => twdlXdin_19_im_tmp  -- sfix16_En15
              );

  u_MUL4_2 : Subsystem_ip_src_Complex4Multiply_block15
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_32_0 => enb_1_32_0,
              ...
              twdlXdin_20_re => twdlXdin_20_re_tmp,  -- sfix16_En15
              twdlXdin_20_im => twdlXdin_20_im_tmp  -- sfix16_En15
              );
  ...
  twdlXdin_19_re <= twdlXdin_19_re_tmp;

  twdlXdin_19_im <= twdlXdin_19_im_tmp;

  twdlXdin_20_re <= twdlXdin_20_re_tmp;

  twdlXdin_20_im <= twdlXdin_20_im_tmp;
