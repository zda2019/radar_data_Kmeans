-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\newsimul\Subsystem_ip_src_Complex4Multiply_block5.vhd
...
ENTITY Subsystem_ip_src_Complex4Multiply_block5 IS
...
END Subsystem_ip_src_Complex4Multiply_block5;


ARCHITECTURE rtl OF Subsystem_ip_src_Complex4Multiply_block5 IS
  ...
  SIGNAL twdl_3_8_re_signed               : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdl_re_reg                      : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdl_3_8_im_signed               : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL twdlXdin_8_re_tmp                : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL twdlXdin_8_im_tmp                : signed(15 DOWNTO 0);  -- sfix16_En15
...
BEGIN
  ...
  twdlXdin_8_re_tmp <= mulResFP_re(29 DOWNTO 14);

  twdlXdin_8_re <= std_logic_vector(twdlXdin_8_re_tmp);

  twdlXdin_8_im_tmp <= mulResFP_im(29 DOWNTO 14);
