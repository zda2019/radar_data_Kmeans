-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\newsimul\Subsystem_ip_src_RADIX22FFT_SDNF1_5_block.vhd
...
ENTITY Subsystem_ip_src_RADIX22FFT_SDNF1_5_block IS
...
END Subsystem_ip_src_RADIX22FFT_SDNF1_5_block;


ARCHITECTURE rtl OF Subsystem_ip_src_RADIX22FFT_SDNF1_5_block IS

  -- Component Declarations
  COMPONENT Subsystem_ip_src_Complex4Multiply_block28
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
  ...
  FOR ALL : Subsystem_ip_src_Complex4Multiply_block28
    USE ENTITY work.Subsystem_ip_src_Complex4Multiply_block28(rtl);
...
BEGIN
  u_MUL4_2 : Subsystem_ip_src_Complex4Multiply_block28
    PORT MAP( clk => clk,
              reset => reset,
  ...
  BEGIN
    ...
    dout_4_vld_1 <= Radix22ButterflyG1_NF_dinXtwdl_vld_dly1;
