-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\newsimul\Subsystem_ip_src_FilterTapWvldIn_block20.vhd
...
ENTITY Subsystem_ip_src_FilterTapWvldIn_block20 IS
...
END Subsystem_ip_src_FilterTapWvldIn_block20;


ARCHITECTURE rtl OF Subsystem_ip_src_FilterTapWvldIn_block20 IS

  -- Signals
  SIGNAL dinReg2_21_re_signed             : signed(15 DOWNTO 0);  -- sfix16_En15
...
BEGIN
  dinReg2_21_re_signed <= signed(dinReg2_21_re);
  ...
  fTap_output : PROCESS (addin_signed, coefIn_0_signed, dinReg2_21_re_signed, fTap_addout_reg,
  ...
  BEGIN
    ...
    fTap_din_reg_next <= dinReg2_21_re_signed;
