-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\newsimul\Subsystem_ip_src_TWDLMULT_SDNF1_3_block9.vhd
...
ENTITY Subsystem_ip_src_TWDLMULT_SDNF1_3_block9 IS
...
END Subsystem_ip_src_TWDLMULT_SDNF1_3_block9;


ARCHITECTURE rtl OF Subsystem_ip_src_TWDLMULT_SDNF1_3_block9 IS

  -- Component Declarations
  COMPONENT Subsystem_ip_src_Complex4Multiply_block16
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
  ...
  COMPONENT Subsystem_ip_src_Complex4Multiply_block17
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
  ...
  FOR ALL : Subsystem_ip_src_Complex4Multiply_block16
    USE ENTITY work.Subsystem_ip_src_Complex4Multiply_block16(rtl);

  FOR ALL : Subsystem_ip_src_Complex4Multiply_block17
    USE ENTITY work.Subsystem_ip_src_Complex4Multiply_block17(rtl);
  ...
  SIGNAL twdlXdin_21_re_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL twdlXdin_21_im_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16
...
BEGIN
  u_MUL4_1 : Subsystem_ip_src_Complex4Multiply_block16
    PORT MAP( clk => clk,
              reset => reset,
              ...
              twdlXdin_21_re => twdlXdin_21_re_tmp,  -- sfix16_En15
              twdlXdin_21_im => twdlXdin_21_im_tmp  -- sfix16_En15
              );

  u_MUL4_2 : Subsystem_ip_src_Complex4Multiply_block17
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_32_0 => enb_1_32_0,
              ...
              twdlXdin_22_re => twdlXdin_22_re_tmp,  -- sfix16_En15
              twdlXdin_22_im => twdlXdin_22_im_tmp  -- sfix16_En15
              );
