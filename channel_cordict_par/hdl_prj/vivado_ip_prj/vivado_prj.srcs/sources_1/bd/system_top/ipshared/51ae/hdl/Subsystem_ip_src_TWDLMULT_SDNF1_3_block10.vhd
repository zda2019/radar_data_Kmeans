-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\newsimul\Subsystem_ip_src_TWDLMULT_SDNF1_3_block10.vhd
...
ENTITY Subsystem_ip_src_TWDLMULT_SDNF1_3_block10 IS
...
END Subsystem_ip_src_TWDLMULT_SDNF1_3_block10;


ARCHITECTURE rtl OF Subsystem_ip_src_TWDLMULT_SDNF1_3_block10 IS

  -- Component Declarations
  COMPONENT Subsystem_ip_src_Complex4Multiply_block18
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
  ...
  COMPONENT Subsystem_ip_src_Complex4Multiply_block19
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
  ...
  FOR ALL : Subsystem_ip_src_Complex4Multiply_block18
    USE ENTITY work.Subsystem_ip_src_Complex4Multiply_block18(rtl);

  FOR ALL : Subsystem_ip_src_Complex4Multiply_block19
    USE ENTITY work.Subsystem_ip_src_Complex4Multiply_block19(rtl);
  ...
  SIGNAL twdlXdin_23_re_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL twdlXdin_23_im_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  SIGNAL twdlXdin_24_re_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL twdlXdin_24_im_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16

BEGIN
  u_MUL4_1 : Subsystem_ip_src_Complex4Multiply_block18
    PORT MAP( clk => clk,
              reset => reset,
              ...
              twdlXdin_23_re => twdlXdin_23_re_tmp,  -- sfix16_En15
              twdlXdin_23_im => twdlXdin_23_im_tmp  -- sfix16_En15
              );

  u_MUL4_2 : Subsystem_ip_src_Complex4Multiply_block19
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_32_0 => enb_1_32_0,
              ...
              twdlXdin_24_re => twdlXdin_24_re_tmp,  -- sfix16_En15
              twdlXdin_24_im => twdlXdin_24_im_tmp  -- sfix16_En15
              );
