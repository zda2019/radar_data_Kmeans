-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\newsimul\Subsystem_ip_src_TWDLROM_3_29.vhd
...
-- Source Path: newsimul/Subsystem/Subsystem/Channelizer/FFT/TWDLROM_3_29
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Subsystem_ip_src_TWDLROM_3_29 IS
...
END Subsystem_ip_src_TWDLROM_3_29;


ARCHITECTURE rtl OF Subsystem_ip_src_TWDLROM_3_29 IS
  ...
  SIGNAL twdl_3_29_re_tmp                 : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdl_3_29_im_tmp                 : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  ...
  BEGIN
    ...
    ELSE 
      ...
      END CASE;
    END IF;
    twdl_3_29_re_tmp <= twdlIn_re;
    twdl_3_29_im_tmp <= twdlIn_im;
  END PROCESS Radix22TwdlOctCorr_output;


  twdl_3_29_re <= std_logic_vector(twdl_3_29_re_tmp);

  twdl_3_29_im <= std_logic_vector(twdl_3_29_im_tmp);
