-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\newsimul\Subsystem_ip_src_TWDLMULT_SDNF1_3_block4.vhd
...
ENTITY Subsystem_ip_src_TWDLMULT_SDNF1_3_block4 IS
...
END Subsystem_ip_src_TWDLMULT_SDNF1_3_block4;


ARCHITECTURE rtl OF Subsystem_ip_src_TWDLMULT_SDNF1_3_block4 IS

  -- Component Declarations
  COMPONENT Subsystem_ip_src_Complex4Multiply_block7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
  ...
  COMPONENT Subsystem_ip_src_Complex4Multiply_block8
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
  ...
  FOR ALL : Subsystem_ip_src_Complex4Multiply_block7
    USE ENTITY work.Subsystem_ip_src_Complex4Multiply_block7(rtl);

  FOR ALL : Subsystem_ip_src_Complex4Multiply_block8
    USE ENTITY work.Subsystem_ip_src_Complex4Multiply_block8(rtl);

  -- Signals
  SIGNAL dout_6_re_signed                 : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL din1_re_dly1                     : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL din1_re_dly2                     : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dout_6_im_signed                 : signed(15 DOWNTO 0);  -- sfix16_En15
  ...
  SIGNAL twdlXdin_11_re_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL twdlXdin_11_im_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL dout_8_re_signed                 : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL din2_re_dly1                     : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL din2_re_dly2                     : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dout_8_im_signed                 : signed(15 DOWNTO 0);  -- sfix16_En15
  ...
  SIGNAL twdlXdin_12_re_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL twdlXdin_12_im_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16

BEGIN
  u_MUL4_1 : Subsystem_ip_src_Complex4Multiply_block7
    PORT MAP( clk => clk,
              reset => reset,
              ...
              twdlXdin_11_re => twdlXdin_11_re_tmp,  -- sfix16_En15
              twdlXdin_11_im => twdlXdin_11_im_tmp  -- sfix16_En15
              );

  u_MUL4_2 : Subsystem_ip_src_Complex4Multiply_block8
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_32_0 => enb_1_32_0,
              ...
              twdlXdin_12_re => twdlXdin_12_re_tmp,  -- sfix16_En15
              twdlXdin_12_im => twdlXdin_12_im_tmp  -- sfix16_En15
              );
