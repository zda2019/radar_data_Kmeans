-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\newsimul\Subsystem_ip_src_RADIX22FFT_SDNF2_4_block7.vhd
...
ENTITY Subsystem_ip_src_RADIX22FFT_SDNF2_4_block7 IS
...
END Subsystem_ip_src_RADIX22FFT_SDNF2_4_block7;


ARCHITECTURE rtl OF Subsystem_ip_src_RADIX22FFT_SDNF2_4_block7 IS
  ...
  BEGIN
    ...
    IF rotate_17 /= '0' THEN 
      IF dout_1_vld = '1' THEN 
        add_cast_1 := resize(dout_17_re_signed, 17);
        add_cast_2 := resize(dout_21_im_signed, 17);
        Radix22ButterflyG2_NF_btf1_re_reg_next <= add_cast_1 + add_cast_2;
        sub_cast_1 := resize(dout_17_re_signed, 17);
        sub_cast_2 := resize(dout_21_im_signed, 17);
        Radix22ButterflyG2_NF_btf2_re_reg_next <= sub_cast_1 - sub_cast_2;
        add_cast_5 := resize(dout_17_im_signed, 17);
        add_cast_6 := resize(dout_21_re_signed, 17);
        Radix22ButterflyG2_NF_btf2_im_reg_next <= add_cast_5 + add_cast_6;
        sub_cast_5 := resize(dout_17_im_signed, 17);
        sub_cast_6 := resize(dout_21_re_signed, 17);
        Radix22ButterflyG2_NF_btf1_im_reg_next <= sub_cast_5 - sub_cast_6;
      END IF;
    ELSIF dout_1_vld = '1' THEN 
      add_cast := resize(dout_17_re_signed, 17);
      add_cast_0 := resize(dout_21_re_signed, 17);
      Radix22ButterflyG2_NF_btf1_re_reg_next <= add_cast + add_cast_0;
      sub_cast := resize(dout_17_re_signed, 17);
      sub_cast_0 := resize(dout_21_re_signed, 17);
      Radix22ButterflyG2_NF_btf2_re_reg_next <= sub_cast - sub_cast_0;
      add_cast_3 := resize(dout_17_im_signed, 17);
      add_cast_4 := resize(dout_21_im_signed, 17);
      Radix22ButterflyG2_NF_btf1_im_reg_next <= add_cast_3 + add_cast_4;
      sub_cast_3 := resize(dout_17_im_signed, 17);
      sub_cast_4 := resize(dout_21_im_signed, 17);
