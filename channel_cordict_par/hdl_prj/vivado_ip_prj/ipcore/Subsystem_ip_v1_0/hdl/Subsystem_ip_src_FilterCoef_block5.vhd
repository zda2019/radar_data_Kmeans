-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\newsimul\Subsystem_ip_src_FilterCoef_block5.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Subsystem_ip_src_FilterCoef_block5
...
ENTITY Subsystem_ip_src_FilterCoef_block5 IS
  PORT( CoefOut                           :   OUT   vector_of_std_logic_vector16(0 TO 1)  -- sfix16_En19 [2]
        );
END Subsystem_ip_src_FilterCoef_block5;


ARCHITECTURE rtl OF Subsystem_ip_src_FilterCoef_block5 IS
...
BEGIN
  -- CoefReg_1
  CoefData <= to_signed(16#028D#, 16);

  -- CoefReg_2
  CoefData_1 <= to_signed(16#3432#, 16);
