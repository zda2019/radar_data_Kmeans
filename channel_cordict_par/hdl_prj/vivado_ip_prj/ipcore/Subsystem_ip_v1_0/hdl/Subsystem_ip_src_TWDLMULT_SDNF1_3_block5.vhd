-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\newsimul\Subsystem_ip_src_TWDLMULT_SDNF1_3_block5.vhd
...
ENTITY Subsystem_ip_src_TWDLMULT_SDNF1_3_block5 IS
...
END Subsystem_ip_src_TWDLMULT_SDNF1_3_block5;


ARCHITECTURE rtl OF Subsystem_ip_src_TWDLMULT_SDNF1_3_block5 IS

  -- Component Declarations
  COMPONENT Subsystem_ip_src_Complex4Multiply_block9
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
  ...
  COMPONENT Subsystem_ip_src_Complex4Multiply_block10
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
  ...
  FOR ALL : Subsystem_ip_src_Complex4Multiply_block9
    USE ENTITY work.Subsystem_ip_src_Complex4Multiply_block9(rtl);

  FOR ALL : Subsystem_ip_src_Complex4Multiply_block10
    USE ENTITY work.Subsystem_ip_src_Complex4Multiply_block10(rtl);

  -- Signals
  SIGNAL dout_10_re_signed                : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL din1_re_dly1                     : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL din1_re_dly2                     : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dout_10_im_signed                : signed(15 DOWNTO 0);  -- sfix16_En15
  ...
  SIGNAL twdlXdin_13_re_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL twdlXdin_13_im_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16
...
BEGIN
  u_MUL4_1 : Subsystem_ip_src_Complex4Multiply_block9
    PORT MAP( clk => clk,
              reset => reset,
              ...
              twdlXdin_13_re => twdlXdin_13_re_tmp,  -- sfix16_En15
              twdlXdin_13_im => twdlXdin_13_im_tmp  -- sfix16_En15
              );

  u_MUL4_2 : Subsystem_ip_src_Complex4Multiply_block10
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_32_0 => enb_1_32_0,
              ...
              twdlXdin_14_re => twdlXdin_14_re_tmp,  -- sfix16_En15
              twdlXdin_14_im => twdlXdin_14_im_tmp  -- sfix16_En15
              );
  ...
  twdlXdin_13_re <= twdlXdin_13_re_tmp;

  twdlXdin_13_im <= twdlXdin_13_im_tmp;
