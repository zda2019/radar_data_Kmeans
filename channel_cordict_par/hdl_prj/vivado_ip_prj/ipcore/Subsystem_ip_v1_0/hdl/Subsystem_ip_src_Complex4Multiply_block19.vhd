-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\newsimul\Subsystem_ip_src_Complex4Multiply_block19.vhd
...
ENTITY Subsystem_ip_src_Complex4Multiply_block19 IS
...
END Subsystem_ip_src_Complex4Multiply_block19;


ARCHITECTURE rtl OF Subsystem_ip_src_Complex4Multiply_block19 IS
  ...
  SIGNAL twdl_3_24_re_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdl_re_reg                      : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdl_3_24_im_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL twdlXdin_24_re_tmp               : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL twdlXdin_24_im_tmp               : signed(15 DOWNTO 0);  -- sfix16_En15
...
BEGIN
  ...
  twdl_3_24_re_signed <= signed(twdl_3_24_re);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_32_0 = '1' THEN
        twdl_re_reg <= twdl_3_24_re_signed;
      END IF;
    END IF;
  END PROCESS intdelay_2_process;


  twdl_3_24_im_signed <= signed(twdl_3_24_im);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_32_0 = '1' THEN
        twdl_im_reg <= twdl_3_24_im_signed;
      END IF;
    END IF;
  ...
  twdlXdin_24_re_tmp <= mulResFP_re(29 DOWNTO 14);

  twdlXdin_24_re <= std_logic_vector(twdlXdin_24_re_tmp);

  twdlXdin_24_im_tmp <= mulResFP_im(29 DOWNTO 14);

  twdlXdin_24_im <= std_logic_vector(twdlXdin_24_im_tmp);
