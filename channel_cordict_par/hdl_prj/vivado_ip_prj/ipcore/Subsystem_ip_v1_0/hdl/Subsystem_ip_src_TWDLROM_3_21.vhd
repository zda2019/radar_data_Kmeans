-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\newsimul\Subsystem_ip_src_TWDLROM_3_21.vhd
...
-- Source Path: newsimul/Subsystem/Subsystem/Channelizer/FFT/TWDLROM_3_21
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Subsystem_ip_src_TWDLROM_3_21 IS
...
END Subsystem_ip_src_TWDLROM_3_21;


ARCHITECTURE rtl OF Subsystem_ip_src_TWDLROM_3_21 IS
  ...
  SIGNAL twdl_3_21_re_tmp                 : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL twdl_3_21_im_tmp                 : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  ...
  BEGIN
    ...
    ELSE 
      ...
      END CASE;
    END IF;
    twdl_3_21_re_tmp <= twdlIn_re;
    twdl_3_21_im_tmp <= twdlIn_im;
  END PROCESS Radix22TwdlOctCorr_output;


  twdl_3_21_re <= std_logic_vector(twdl_3_21_re_tmp);

  twdl_3_21_im <= std_logic_vector(twdl_3_21_im_tmp);
