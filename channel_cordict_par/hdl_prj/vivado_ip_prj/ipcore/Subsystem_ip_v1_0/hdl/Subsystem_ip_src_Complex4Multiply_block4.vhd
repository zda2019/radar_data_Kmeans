-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\newsimul\Subsystem_ip_src_Complex4Multiply_block4.vhd
...
ENTITY Subsystem_ip_src_Complex4Multiply_block4 IS
...
END Subsystem_ip_src_Complex4Multiply_block4;


ARCHITECTURE rtl OF Subsystem_ip_src_Complex4Multiply_block4 IS
  ...
  SIGNAL twdlXdin_7_re_tmp                : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL twdlXdin_7_im_tmp                : signed(15 DOWNTO 0);  -- sfix16_En15
...
BEGIN
  ...
  twdlXdin_7_re_tmp <= mulResFP_re(29 DOWNTO 14);

  twdlXdin_7_re <= std_logic_vector(twdlXdin_7_re_tmp);

  twdlXdin_7_im_tmp <= mulResFP_im(29 DOWNTO 14);
