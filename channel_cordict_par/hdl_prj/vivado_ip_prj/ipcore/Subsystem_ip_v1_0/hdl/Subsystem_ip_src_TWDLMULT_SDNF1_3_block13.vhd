-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\newsimul\Subsystem_ip_src_TWDLMULT_SDNF1_3_block13.vhd
...
ENTITY Subsystem_ip_src_TWDLMULT_SDNF1_3_block13 IS
...
END Subsystem_ip_src_TWDLMULT_SDNF1_3_block13;


ARCHITECTURE rtl OF Subsystem_ip_src_TWDLMULT_SDNF1_3_block13 IS

  -- Component Declarations
  COMPONENT Subsystem_ip_src_Complex4Multiply_block23
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
  ...
  COMPONENT Subsystem_ip_src_Complex4Multiply_block24
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
  ...
  FOR ALL : Subsystem_ip_src_Complex4Multiply_block23
    USE ENTITY work.Subsystem_ip_src_Complex4Multiply_block23(rtl);

  FOR ALL : Subsystem_ip_src_Complex4Multiply_block24
    USE ENTITY work.Subsystem_ip_src_Complex4Multiply_block24(rtl);
...
BEGIN
  u_MUL4_1 : Subsystem_ip_src_Complex4Multiply_block23
    PORT MAP( clk => clk,
              reset => reset,
              ...
              twdlXdin_29_re => twdlXdin_29_re_tmp,  -- sfix16_En15
              twdlXdin_29_im => twdlXdin_29_im_tmp  -- sfix16_En15
              );

  u_MUL4_2 : Subsystem_ip_src_Complex4Multiply_block24
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_32_0 => enb_1_32_0,
              ...
              twdlXdin_30_re => twdlXdin_30_re_tmp,  -- sfix16_En15
              twdlXdin_30_im => twdlXdin_30_im_tmp  -- sfix16_En15
              );
