-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\newsimul\Subsystem_ip_src_FilterTapWvldIn_block.vhd
...
ENTITY Subsystem_ip_src_FilterTapWvldIn_block IS
...
END Subsystem_ip_src_FilterTapWvldIn_block;


ARCHITECTURE rtl OF Subsystem_ip_src_FilterTapWvldIn_block IS
...
BEGIN
  ...
  fTap_output : PROCESS (addin_signed, coefIn_0_signed, dinReg2_1_re_signed, fTap_addout_reg,
  ...
  BEGIN
    ...
    fTap_din_reg_next <= dinReg2_1_re_signed;
