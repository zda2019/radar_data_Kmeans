-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\newsimul\Subsystem_ip_src_TWDLMULT_SDNF1_3_block14.vhd
...
ENTITY Subsystem_ip_src_TWDLMULT_SDNF1_3_block14 IS
...
END Subsystem_ip_src_TWDLMULT_SDNF1_3_block14;


ARCHITECTURE rtl OF Subsystem_ip_src_TWDLMULT_SDNF1_3_block14 IS

  -- Component Declarations
  COMPONENT Subsystem_ip_src_Complex4Multiply_block25
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
  ...
  COMPONENT Subsystem_ip_src_Complex4Multiply_block26
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
  ...
  FOR ALL : Subsystem_ip_src_Complex4Multiply_block25
    USE ENTITY work.Subsystem_ip_src_Complex4Multiply_block25(rtl);

  FOR ALL : Subsystem_ip_src_Complex4Multiply_block26
    USE ENTITY work.Subsystem_ip_src_Complex4Multiply_block26(rtl);

  -- Signals
  SIGNAL dout_30_re_signed                : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL din1_re_dly1                     : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL din1_re_dly2                     : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dout_30_im_signed                : signed(15 DOWNTO 0);  -- sfix16_En15
  ...
  SIGNAL twdlXdin_31_re_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL twdlXdin_31_im_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL dout_32_re_signed                : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL din2_re_dly1                     : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL din2_re_dly2                     : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dout_32_im_signed                : signed(15 DOWNTO 0);  -- sfix16_En15
  ...
  SIGNAL twdlXdin_32_re_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL twdlXdin_32_im_tmp               : std_logic_vector(15 DOWNTO 0);  -- ufix16

BEGIN
  u_MUL4_1 : Subsystem_ip_src_Complex4Multiply_block25
    PORT MAP( clk => clk,
              reset => reset,
              ...
              twdlXdin_31_re => twdlXdin_31_re_tmp,  -- sfix16_En15
              twdlXdin_31_im => twdlXdin_31_im_tmp  -- sfix16_En15
              );

  u_MUL4_2 : Subsystem_ip_src_Complex4Multiply_block26
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_32_0 => enb_1_32_0,
              ...
              twdlXdin_32_re => twdlXdin_32_re_tmp,  -- sfix16_En15
              twdlXdin_32_im => twdlXdin_32_im_tmp  -- sfix16_En15
              );
  ...
  twdlXdin_31_re <= twdlXdin_31_re_tmp;

  twdlXdin_31_im <= twdlXdin_31_im_tmp;

  twdlXdin_32_re <= twdlXdin_32_re_tmp;

  twdlXdin_32_im <= twdlXdin_32_im_tmp;
