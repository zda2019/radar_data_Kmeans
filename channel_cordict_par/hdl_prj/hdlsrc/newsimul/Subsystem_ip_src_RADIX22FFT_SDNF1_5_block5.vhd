-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\newsimul\Subsystem_ip_src_RADIX22FFT_SDNF1_5_block5.vhd
...
ENTITY Subsystem_ip_src_RADIX22FFT_SDNF1_5_block5 IS
...
END Subsystem_ip_src_RADIX22FFT_SDNF1_5_block5;


ARCHITECTURE rtl OF Subsystem_ip_src_RADIX22FFT_SDNF1_5_block5 IS

  -- Component Declarations
  COMPONENT Subsystem_ip_src_Complex4Multiply_block33
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
  ...
  FOR ALL : Subsystem_ip_src_Complex4Multiply_block33
    USE ENTITY work.Subsystem_ip_src_Complex4Multiply_block33(rtl);
...
BEGIN
  u_MUL4_2 : Subsystem_ip_src_Complex4Multiply_block33
    PORT MAP( clk => clk,
              reset => reset,
  ...
  BEGIN
    ...
    dout_14_vld <= Radix22ButterflyG1_NF_dinXtwdl_vld_dly1;
