-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\newsimul\Subsystem_ip_src_RADIX22FFT_SDNF2_4_block11.vhd
...
-- Source Path: newsimul/Subsystem/Subsystem/Channelizer/FFT/RADIX22FFT_SDNF2_4
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Subsystem_ip_src_RADIX22FFT_SDNF2_4_block11 IS
...
END Subsystem_ip_src_RADIX22FFT_SDNF2_4_block11;


ARCHITECTURE rtl OF Subsystem_ip_src_RADIX22FFT_SDNF2_4_block11 IS

  -- Signals
  SIGNAL dout_25_re_signed                : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dout_25_im_signed                : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dout_29_re_signed                : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dout_29_im_signed                : signed(15 DOWNTO 0);  -- sfix16_En15
  ...
  SIGNAL dout_25_re_tmp                   : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dout_25_im_tmp                   : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dout_26_re_tmp                   : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dout_26_im_tmp                   : signed(15 DOWNTO 0);  -- sfix16_En15
...
BEGIN
  ...
  Radix22ButterflyG2_NF_output : PROCESS (Radix22ButterflyG2_NF_btf1_im_reg, Radix22ButterflyG2_NF_btf1_re_reg,
       ...
       Radix22ButterflyG2_NF_din_vld_dly, dout_1_vld, dout_25_im_signed,
       dout_25_re_signed, dout_29_im_signed, dout_29_re_signed, rotate_25)
  ...
  BEGIN
    ...
    IF rotate_25 /= '0' THEN 
      IF dout_1_vld = '1' THEN 
        add_cast_1 := resize(dout_25_re_signed, 17);
        add_cast_2 := resize(dout_29_im_signed, 17);
        Radix22ButterflyG2_NF_btf1_re_reg_next <= add_cast_1 + add_cast_2;
        sub_cast_1 := resize(dout_25_re_signed, 17);
        sub_cast_2 := resize(dout_29_im_signed, 17);
        Radix22ButterflyG2_NF_btf2_re_reg_next <= sub_cast_1 - sub_cast_2;
        add_cast_5 := resize(dout_25_im_signed, 17);
        add_cast_6 := resize(dout_29_re_signed, 17);
        Radix22ButterflyG2_NF_btf2_im_reg_next <= add_cast_5 + add_cast_6;
        sub_cast_5 := resize(dout_25_im_signed, 17);
        sub_cast_6 := resize(dout_29_re_signed, 17);
        Radix22ButterflyG2_NF_btf1_im_reg_next <= sub_cast_5 - sub_cast_6;
      END IF;
    ELSIF dout_1_vld = '1' THEN 
      add_cast := resize(dout_25_re_signed, 17);
      add_cast_0 := resize(dout_29_re_signed, 17);
      Radix22ButterflyG2_NF_btf1_re_reg_next <= add_cast + add_cast_0;
      sub_cast := resize(dout_25_re_signed, 17);
      sub_cast_0 := resize(dout_29_re_signed, 17);
      Radix22ButterflyG2_NF_btf2_re_reg_next <= sub_cast - sub_cast_0;
      add_cast_3 := resize(dout_25_im_signed, 17);
      add_cast_4 := resize(dout_29_im_signed, 17);
      Radix22ButterflyG2_NF_btf1_im_reg_next <= add_cast_3 + add_cast_4;
      sub_cast_3 := resize(dout_25_im_signed, 17);
      sub_cast_4 := resize(dout_29_im_signed, 17);
  ...
  dout_25_re_1 <= std_logic_vector(dout_25_re_tmp);

  dout_25_im_1 <= std_logic_vector(dout_25_im_tmp);
